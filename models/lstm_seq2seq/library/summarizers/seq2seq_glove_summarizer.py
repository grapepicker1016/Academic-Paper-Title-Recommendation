...
class Seq2SeqGloVeSummarizer(object):
    ...
    def get_weight_file_path(model_dir_path):
        return os.path.join(model_dir_path, Seq2SeqGloVeSummarizer.model_name + '-weights.h5')

    @staticmethod
    def get_config_file_path(model_dir_path):
        return os.path.join(model_dir_path, Seq2SeqGloVeSummarizer.model_name + '-config.npy')

    @staticmethod
    def get_architecture_file_path(model_dir_path):
        return os.path.join(model_dir_path, Seq2SeqGloVeSummarizer.model_name + '-architecture.json')
